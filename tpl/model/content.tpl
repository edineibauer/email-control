            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
                ...
                <tr>
                    <td align="center" valign="top" id="m_5372895143664279880templateFooter"
                        style="background:rgba(0,0,0,0.4) none no-repeat center/cover;background-color:rgba(0,0,0,0.4);background-image:none;background-repeat:no-repeat;background-position:center;background-size:cover;border-top:0;border-bottom:0;padding-top:10px;padding-bottom:40px">
